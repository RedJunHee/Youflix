package com.youflix.videoplaylistsync.util;
   ...
   public static String getCurrentDateTimeToString() {
	 ...
	 */
	  public static String getDateToString(Date date, String pattern) {
		...
		/**
		 * @FileName : 입력받은 DateString의 크기 비교 첫 파라미터가 크면 true
		 * @Project : ContentAPI MY
		 * @Date : 2020.11.20
		 * @Author : 조 준 희
		 * @Description : - 사용 예 compareDateToDate ("1999-10-21 10:54:44.111", "1999-10-21 10:54:44.111")
		 * @History :
		 */
	  public static Boolean compareDateToDate (String firstDate, String secondDate) throws Exception
	  {
		  Date date1 = getStringToDate(firstDate);
		  Date date2 = getStringToDate(secondDate);
